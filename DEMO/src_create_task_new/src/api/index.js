...
export function MEMBER_LEVEL_LIST(data) {
    return Request('/api/v6/c_minipeace/member_level/level_info/get', 'POST', undefined, data)
}
 ...
 * 查询营销任务会员回购率及详情
 */
export function MEMBER_REPO_INFOR(data) {
    return Request('/api/v6/c_minipeace/marketing_task/member_repo_info/get', 'POST', undefined, data)
}

// /**
//  * 查询指定门店下的导购任务列表
//  */
// export function MARKETING_TASK_LIST_BY_SHOP(data) {
//     return Request('/api/v6/c_minipeace/marketing_task/marketing_task_list_by_shop/get', 'POST', undefined, data)
// }

/**
 * 查询营销任务列表
 */
export function MARKETING_TASK_LIST(data) {
    return Request('/api/v6/c_minipeace/marketing_task/marketing_task_list/get', 'POST', undefined, data)
}

/**
 * 查询营销任务主题列表
 */
export function MARKETING_TASK_TYPE_LIST(data) {
    return Request('/api/v6/c_minipeace/marketing_task_type/marketing_task_type_list/get', 'POST', undefined, data)
}

/**
 * 创建任务主题
 */
export function CREATE_TASK_TYPE(data) {
    return Request('/api/v6/c_minipeace/marketing_task_type/create_task_type/post', 'POST', undefined, data)
}

/**
 * 更新导购任务主题接口
 */
export function MARKETING_TASK_TYPE_UPDATE_INFO(data) {
    return Request('/api/v6/c_minipeace/marketing_task_type/update_info/post', 'POST', undefined, data)
}

/**
 * 查询营销任务主题详情
 */
export function MARKETING_TASK_TYPE_GET(data) {
    return Request('/api/v6/c_minipeace/marketing_task_type/marketing_task_type_info/get', 'POST', undefined, data)
}
