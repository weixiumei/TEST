...
(function( $, window, document, undefined ) {
	...
	function _fnAjaxUpdateDraw ( settings, json )
	{
		...
		var recordsTotal    = compat( 'iTotalRecords',        'record_qty' );
		var recordsFiltered = compat( 'iTotalDisplayRecords', 'record_qty' );
	...
	*/
	...
	"_fnConstruct": function ()
	{
		...
		if ( this.s.loadingIndicator )
		{
			...
			// 	.css('display', 'none');
			this.dom.loader = $('<div class="dataTables_processing DTS_Loading"></div>')
				.css('display', 'none');
